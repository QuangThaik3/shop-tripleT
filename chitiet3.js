...
const productPurple = document.querySelector('#product-purple');
const productBlue = document.querySelector('#product-blue');
...
productBlack.addEventListener('change', function() {
    if (productBlack.checked) {
        img.src = "img/iphone3-1.webp";
    }
});

productSliver.addEventListener('change', function() {
    if (productSliver.checked) {
        img.src = "img/iphone3-2.png";
    }
});

productGod.addEventListener('change', function() {
    if (productGod.checked) {
        img.src = "img/iphone3-3.png";
    }
});

productPurple.addEventListener('change', function() {
    if (productPurple.checked) {
        img.src = "img/iphone3-4.webp";
    }
});

productBlue.addEventListener('change', function() {
    if (productBlue.checked) {
        img.src = "img/iphone3-5.png";
    }
});

productYellow.addEventListener('change', function() {
    if (productYellow.checked) {
        img.src = "img/iphone3-6.jpeg";
    }
});
