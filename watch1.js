...
const productMidnight = document.querySelector('#product-midnight');
...
productBlack.addEventListener('change', function() {
    if (productBlack.checked) {
        img.src = "img/watch1-1.png";
    }
});

productSliver.addEventListener('change', function() {
    if (productSliver.checked) {
        img.src = "img/watch1-2.webp";
    }
});

productGod.addEventListener('change', function() {
    if (productGod.checked) {
        img.src = "img/watch1-3.webp";
    }
});

productMidnight.addEventListener('change', function() {
    if (productMidnight.checked) {
        img.src = "img/watch1-4.webp";
    }
});
